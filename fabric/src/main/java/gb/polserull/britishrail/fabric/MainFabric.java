...
public class MainFabric implements ModInitializer {
	...
	public void onInitialize() {
		Main.init(MainFabric::registerItem, MainFabric::registerBlock, MainFabric::registerBlock, MainFabric::registerBlockEntityType, MainFabric::registerEntityType, MainFabric::registerSoundEvent);
