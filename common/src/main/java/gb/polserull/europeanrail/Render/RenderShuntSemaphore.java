...
public class RenderShuntSemaphore<T extends BlockSignalSemaphoreBase.TileEntitySignalSemaphoreBase> extends RenderSignalBase<T> {

    private static final int ANGLE = 55;
    private static final int SPEED = 4;

    public RenderShuntSemaphore(BlockEntityRenderDispatcher dispatcher, boolean isSingleSided) {
    ...
    protected void render(PoseStack matrices, MultiBufferSource vertexConsumers, VertexConsumer vertexConsumer, T entity, float tickDelta, Direction facing, int occupiedAspect, boolean isBackSide) {
        ...
        IDrawing.drawTexture(matrices, vertexConsumer, -0.2525F, 0.296875F, -0.190625F, 0.0625F, 0.453125F, -0.190625F, facing.getOpposite(), angle < ANGLE / 2F ? 0xFFFF0000 : 0xFF00FF00, MAX_LIGHT_GLOWING);
        ...
        if (world != null) {
            ...
            final VertexConsumer vertexConsumer2 = vertexConsumers.getBuffer(MoreRenderLayers.getExterior(new ResourceLocation("europeanrail:textures/block/shunt_semaphore.png")));
